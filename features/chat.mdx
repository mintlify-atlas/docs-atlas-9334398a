...
<Steps>
  <Step title="NativeConstruct — binding the subsystem delegate">
    ...
    void UChatWidget::NativeConstruct()
    {
        ...
        // ...
        if (UGameClientSubsystem* GCS = GetGameClientSubsystem())
        {
            GCS->OnChatMessageReceived.AddUniqueDynamic(
  ...
  <Step title="SubmitChat — sending to the server">
    ...
    bool UChatWidget::SubmitChat()
    {
        ...
        bool bSent = false;
        if (UGameClientSubsystem* GCS = GetGameClientSubsystem())
            bSent = GCS->SendChatMessage(Message);
  ...
  <Step title="NativeDestruct — unbinding">
    ...
    void UChatWidget::NativeDestruct()
    {
        UnbindChatInput();
        if (UGameClientSubsystem* GCS = GetGameClientSubsystem())
            GCS->OnChatMessageReceived.RemoveDynamic(
                this, &UChatWidget::HandleChatMessageReceived);
