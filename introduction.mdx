...
description: "A production-ready Windows IOCP C++ game server paired with an ASP.NET Core auth service, MariaDB, Redis, and a UE5.4 client — built for large-scale MMO development."
---
