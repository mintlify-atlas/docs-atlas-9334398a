---
title: "Quickstart: Run the Full UE5 IOCP MMO Server Locally"
sidebarTitle: "Quickstart"
description: "Spin up MariaDB, Redis, Prometheus, Grafana, the ASP.NET Core AuthServer, the C++ IOCP GameServer, and the UE5.4 client on one Windows machine."
---
