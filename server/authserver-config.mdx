---
title: "Configure the ASP.NET Core AuthServer"
sidebarTitle: "AuthServer Config"
description: "Reference for every appsettings.json section, token lifecycle, and input validation rules for the ASP.NET Core AuthServer."
---
