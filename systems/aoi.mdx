...
description: "How the server uses a spatial cell grid to limit movement and monster notifications to nearby players, with visibility tracking and observer maps."
---
