---
title: "Server-Side Game Simulation Tick Loop"
sidebarTitle: "Game Simulation"
description: "How the single-threaded GameSimulation loop runs at 30 Hz, drains a lock-free command queue each tick, executes six ordered phases, and exposes latency histograms for Grafana."
---
...
|---------------------------------------|---------|-------------------------------------------------|
| `MaxGameSimulationCommandQueueSize`   | 65,536  | Commands dropped (metric: `commandsDrained`) beyond this |
