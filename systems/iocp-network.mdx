---
title: "IOCP Async Networking in the C++ Game Server"
sidebarTitle: "IOCP Network"
description: "How the C++ MMO server uses Windows IOCP with AcceptEx, worker threads, TCP sessions, and a UDP socket on the same port for low-latency movement replication."
---
