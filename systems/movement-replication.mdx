---
title: "Movement Replication: UDP Batching and Prediction"
sidebarTitle: "Movement Replication"
description: "How the server receives C_MoveReq over UDP, applies server-authoritative movement physics, batches snapshots into MoveBatchNotify datagrams, and supports client-side prediction reconciliation."
---
