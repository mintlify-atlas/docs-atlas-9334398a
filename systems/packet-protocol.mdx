---
title: "Binary Packet Protocol: IDs, Headers, and Protobuf"
sidebarTitle: "Packet Protocol"
description: "Reference for the 4-byte binary header, every packet ID by range, Protobuf message schemas, MoveBatchNotify binary layout, and error codes."
---
